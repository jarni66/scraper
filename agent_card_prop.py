...
with open('agent/agent_info.json') as f:
    out = json.load(f)
...
for agent_id in agent_ids:
    ...
    for properties_link in agent_props.keys():
        ...
        if links_prop != None:
                ...
                for page in range(1,last_page+1):
                    ...
                    for prop in links_prop:
                        ...
                        try:
                            ...
                            with open('agent/agent_prop.json', 'w') as f:
                                json.dump(datas, f)
                        except:
                            pass
            except:
            ...
            pass
    agent_done.append(agent_id)
    datas_done = {'done':agent_done}
    with open('agent/agent_prop_done.json', 'w') as f:
        json.dump(datas_done, f)
