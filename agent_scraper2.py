    ...
    for properties_link in agent_props.keys():
        ...
        try:
            ...
            for page in range(1,last_page+1):
                if properties_link == 'resident_sell':
                    page_url = f'https://www.rumah.com/properti-dijual/{page}?agent_id={agent_id}&market=residential'
                elif properties_link == 'resident_rent':
                    page_url = f'https://www.rumah.com/properti-disewa/{page}?agent_id={agent_id}&market=residential'

                elif properties_link == 'commercial_sell':
                    page_url = f'https://www.rumah.com/properti-dijual/{page}?agent_id={agent_id}&market=commercial'

                elif properties_link == 'commercial_rent':
                    page_url = f'https://www.rumah.com/properti-disewa/{page}?agent_id={agent_id}&market=commercial'
